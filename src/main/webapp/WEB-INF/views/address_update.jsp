...
<h2 style="text-align: center;">배송지 수정</h2>
...
<form method="post" action="${pageContext.request.contextPath}/product/address_manage/update">
	...
	<div style="">
		<div style="margin: 0 auto; width: 700px;">
			...
			<input type="text" name="address_name" value="${address.address_name}"><br>
            ...
            <input type="hidden" id="address_content" name="address_content" value="${address.address_content}">
